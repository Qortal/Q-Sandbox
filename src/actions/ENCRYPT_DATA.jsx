...
export const ENCRYPT_DATA = ({ myAddress }) => {
    ...
    >
      <GeneralExplanation>
        <Typography variant="body1">
          Encrypts data provided by the user. This handler takes in data,
          optionally in the form of a file, or a base64 string, and an array of
          public keys to perform group encryption. Returns the encrypted data in
          base64.
        </Typography>
        <Typography variant="body1">
      ...
      <Card>
        ...
        <div className="message-row">
          ...
          >
            ...
            <Spacer height="5px" />
            <Typography>
              Enter a list of public keys. The user executing the qortalRequest
              will automatically have their public key included in the list. So
              if no public key is provided , only the user will be able to
              decrypt the data.{" "}
            </Typography>
          </Box>
          <Spacer height="20px" />
