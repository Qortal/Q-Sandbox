...
export const INVITE_TO_GROUP = ({ myAddress }) => {
...
await qortalRequest({
  ...
  inviteeAddress: "${requestData?.inviteeAddress}",
  inviteTime: ${requestData?.inviteTime}
});
`.trim();
...
`.trim();
  ...
  return (
    ...
    >
      <GeneralExplanation>
        <Typography variant="body1">qortalRequest to invite a user to a group</Typography>
      ...
      <Card>
        ...
        <div className="message-row">
          ...
          >
            ...
            <Spacer height="5px" />
            <Typography>Enter in SECONDS the expiry duration of the invite.</Typography>
          </Box>
          ...
          >
            ...
            <CustomInput
              type="text"
              placeholder="inviteeAddress"
              value={requestData.inviteeAddress}
              name="inviteeAddress"
              onChange={handleChange}
            />
            <Spacer height="10px" />
            ...
            <Spacer height="5px" />
            <Typography>Enter the Qortal address of the user being invited.</Typography>
          </Box>
